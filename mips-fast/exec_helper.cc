...
#define SIGN_EXTEND_IMM(x)   do { x <<= 16; x >>= 16; } while (0)
   ...
   case 4:			// beq
      ...
      _loWPort = FALSE;
      _memControl = FALSE;
      _branchOffset <<= 16; _branchOffset >>= 14; _bd = 1; _btgt = (unsigned)((signed)_pipe_regs_copy.IF_ID._pc+_branchOffset+4);
      break;
   ...
   case 2:			// j
      ...
      _loWPort = FALSE;
      _memControl = FALSE;
      _btgt = ((_pipe_regs_copy.IF_ID._pc+4) & 0xf0000000) | (_branchOffset<<2); _bd = 1;
      break;
